<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="activityList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="活动编号" :show-overflow-tooltip="true" align="center" width="80" prop="activityId" />
      <el-table-column label="活动名称" :show-overflow-tooltip="true" align="center" width="120" prop="name" />
      <el-table-column label="渠道名称" :show-overflow-tooltip="true" align="center" width="120" prop="channelName" />
      <el-table-column label="活动简介" :show-overflow-tooltip="true" align="center" width="180" prop="info" />
      ...
      <el-table-column label="活动状态" align="center" prop="status" width="80">
        <template #default="scope">
        ...
        <el-row>
          <el-col :span="18">
            <el-form-item label="折扣券" prop="discount" v-if="form.type==1">
              <el-input-number style="width: 100%" v-model="form.discount" placeholder="请输入折扣券" :precision="2" :step="0.1" :min="0" :max="10" />
            </el-form-item>
            <el-form-item label="代金券" prop="voucher" v-if="form.type==2">
              <el-input-number style="width: 100%" v-model="form.voucher" placeholder="请输入代金券面值" :precision="2" :step="100" :min="0" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
import { listActivity, listChannel, addActivity, getActivity, updateActivity, delActivity } from "@/api/tienchin/activity.js";
