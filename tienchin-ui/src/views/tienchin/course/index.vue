  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
      ...
      <el-form-item label="适用人群" prop="applyTo">
        <el-select v-model="queryParams.applyTo" placeholder="适用人群" clearable style="width: 200px">
          <el-option
      ...
      <el-form-item label="最低价格" prop="minPrice">
        <el-input-number placeholder="最低价格" v-model="queryParams.minPrice" :precision="2" :step="100" :min="0" />
      </el-form-item>
      <el-form-item label="最高价格" prop="maxPrice">
        <el-input-number placeholder="最高价格" v-model="queryParams.maxPrice" :precision="2" :step="100" :min="0" />
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程编号" :show-overflow-tooltip="true" align="center" width="80" prop="courseId" />
      <el-table-column label="课程类型" align="center" prop="type" width="120">
        <template #default="scope">
          <dict-tag :options="course_type" :value="scope.row.type" />
        </template>
      </el-table-column>
      <el-table-column label="课程名称" :show-overflow-tooltip="true" align="center" width="120" prop="name" />
      <el-table-column label="课程价格" :show-overflow-tooltip="true" align="center" width="120" prop="price" />
      <el-table-column label="课程适用人群" align="center" prop="type" width="150">
        <template #default="scope">
          <dict-tag :options="course_apply_to" :value="scope.row.applyTo" />
        </template>
      </el-table-column>
      <el-table-column label="课程简介" :show-overflow-tooltip="true" align="center" width="180" prop="info" />
<!--      <el-table-column label="课程备注" :show-overflow-tooltip="true" align="center" width="180" prop="remark" />-->
