<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="clueList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="线索编号" :show-overflow-tooltip="true" align="center" width="80" prop="clueId" />
      ...
      <el-table-column label="渠道来源" :show-overflow-tooltip="true" align="center" width="120" prop="channelName" />
      <el-table-column label="创建时间" align="center" prop="createTime" width="180">
        <template #default="scope">
          <span>{{ parseTime(scope.row.createTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column label="线索归属" :show-overflow-tooltip="true" align="center" width="120" prop="owner" />
      <el-table-column label="线索状态" align="center" prop="type" width="120">
        <template #default="scope">
