...
public class ContractController extends BaseController {
    ...
    public AjaxResult showContractPDF(@PathVariable String year, @PathVariable String month, @PathVariable String day, @PathVariable String name, HttpServletResponse response){
        return contractService.showContractPDF(year, month, day, name ,response);
    }
