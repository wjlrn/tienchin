...
public class ActivityVO extends BaseEntity {
    ...
    @Size(min = 1, max = 20, message = "{activity.name.size}", groups = {CreateGroup.class, EditGroup.class})
    @Excel(name = "活动名称")
    private String name;
    ...
    @Size(min = 1, max = 255, message = "{activity.info.size}", groups = {CreateGroup.class, EditGroup.class})
    @Excel(name = "活动简介")
    private String info;
     ...
     * 活动备注
     */
    @Excel(name = "活动备注", dateFormat = "yyyy-MM-dd HH:mm:s")
