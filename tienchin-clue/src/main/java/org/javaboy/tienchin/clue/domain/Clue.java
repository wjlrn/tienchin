...
public class Clue implements Serializable {
    ...
    @NotNull(message = "{clue.id.notnull}", groups = {EditGroup.class})
    private Integer clueId;

    /**
     * 客户姓名
     */
    @NotBlank(message = "{clue.name.notblank}", groups = {CreateGroup.class, EditGroup.class})
    private String name;
     ...
     * 客户电话
     */
    @NotBlank(message = "{clue.phone.notblank}", groups = {CreateGroup.class, EditGroup.class})
