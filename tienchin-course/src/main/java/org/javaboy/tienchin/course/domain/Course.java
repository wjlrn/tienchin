...
public class Course implements Serializable {
     ...
     * 课程价格
     */
    @NotNull(message = "{course.prive.notnull}", groups = {CreateGroup.class, EditGroup.class})
    @Min(value = 0, message = "{course.prive.invalid}", groups = {CreateGroup.class, EditGroup.class})
    @Excel(name = "课程价格")
     ...
     * 课程简介
     */
    @NotNull(message = "{course.info.notnull}", groups = {CreateGroup.class, EditGroup.class})
    @Excel(name = "课程简介")
    private String info;
